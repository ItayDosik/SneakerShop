...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SneakerShop.Models.Product", b =>
                {
                    ...
                    b.Property<string>("ProductPictureURL1")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ProductPictureURL2")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ProductPictureURL3")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SneakerShop.Models.Users", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SneakerShop.Models.Cart", b =>
                {
                    b.HasOne("SneakerShop.Models.Users", "user")
                        .WithMany()
                        .HasForeignKey("UserId");
            ...
            modelBuilder.Entity("SneakerShop.Models.CartItem", b =>
                {
                    ...
                    b.HasOne("SneakerShop.Models.Product", "product")
                        .WithMany()
